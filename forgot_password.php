...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "SELECT * FROM student_details WHERE email = '{$email}' AND regn = '{$regn}' ";
...
<?php	
		...
		{ ?>
			<script> alert("Wrong email or registration number entered"); </script>
			<?php
		}
	}
?>
...
<html>
    ...
    <body>
	  ...
	  <section class="login_form">
		   <div class="container">
			<form name="login" action="forgot_password_script.php" method="post">
			<table>
				<thead>
					<tr>
				...
				<tr>
					...
					<td><input type="text" name="regn" pattern="[1-9]{2}[Uu][0-9]{5}" title="Enter the correct format of registration number" required /></td>
				</tr>
			</table>
			<br>
			<table>
