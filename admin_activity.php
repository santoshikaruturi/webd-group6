    ...
    <body>
	  ...
	  <section>
		<div class="contact-us" class="section scrollspy">
			...
			<div class="options">
				<button type="button"><a href="student_regn.php"> Accept Student Profile </a></button>
				<button type="button"><a href="admin_login.php"> Modify Student Database </a></button>
			</div>
		</div>
	  </section>
