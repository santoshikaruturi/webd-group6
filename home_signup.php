    ...
    <body>
	  ...
	  <section>
		<div class="contact-us" class="section scrollspy">
			...
			<div class="options">
				<button type="button"><a href="student_regn.php"> Sign up as student </a></button>
				<button type="button"><a href="student_login.php"> Login as student </a></button>
				<button type="button"><a href="admin_login.php"> Login as admin </a></button>
			</div>
